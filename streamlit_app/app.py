...
try:
    ...
    # Falls back to an emoji favicon instead of crashing the whole app
    # if the asset is ever missing from the deployed repo.
    _PAGE_ICON = "\U0001F3C0"
...
def render_toggle() -> str:
    ...
    """
    with st.container(key="toggle-row"):
